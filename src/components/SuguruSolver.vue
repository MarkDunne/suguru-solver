      ...
      if (this.isDrawing) {
        ...
        for (let i = 0; i < this.grid_height; i++) {
          for (let j = 0; j < this.grid_width; j++) {
            ...
            this.grid[i][j].top_border = i > 0 && this.grid[i][j].cage_num != this.grid[i - 1][j].cage_num
            this.grid[i][j].bot_border = i < this.grid_height - 1 && this.grid[i][j].cage_num != this.grid[i + 1][j].cage_num

            this.grid[i][j].left_border = j > 0 && this.grid[i][j].cage_num != this.grid[i][j - 1].cage_num
            this.grid[i][j].right_border = j < this.grid_width - 1 && this.grid[i][j].cage_num != this.grid[i][j + 1].cage_num
          }
        }
      }
    },
